...
@section('content')
                ...
                <div class="flex flex-wrap justify-center gap-4 md:gap-10">
                    ...
                    <div class="flag-item flex flex-col items-center justify-center gap-2 cursor-pointer transition-transform duration-300 w-[60px] sm:w-[70px] md:w-[90px]" data-country="{{ $country['code'] }}">
                        <div class="w-[40px] h-[40px] md:w-[60px] md:h-[60px] rounded-full overflow-hidden shadow-lg shadow-black/50 border border-white/10 shrink-0 relative">
                            <img src="{{ asset('assets/img/flags/'.$country['code'].'.svg') }}" class="absolute inset-0 w-full h-full object-cover" alt="">
                        </div>
    ...
    <section id="clients" class="py-24 relative border-t border-white/5 overflow-hidden">
        ...
        <style>
            ...
            .client-img { filter: grayscale(100%) opacity(50%); transition: all 0.3s ease; }
