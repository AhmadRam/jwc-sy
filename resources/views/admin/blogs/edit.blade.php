                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="ar" role="tabpanel">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="content_ar" name="content_ar" class="form-control richtext @error('content_ar') is-invalid @enderror" rows="15">{{ old('content_ar', $blog->content_ar) }}</textarea>
                        ...
                        <div class="tab-pane fade" id="en" role="tabpanel" dir="ltr">
                            ...
                            <div class="mb-3 text-start">
                                ...
                                <textarea id="content_en" name="content_en" class="form-control richtext @error('content_en') is-invalid @enderror" rows="15">{{ old('content_en', $blog->content_en) }}</textarea>
