        ...
        <div class="container mx-auto px-6">
            ...
            <div class="max-w-2xl mx-auto text-center mb-12">
                ...
                <div class="flex gap-4 md:gap-5 justify-center items-center flex-wrap">
                    <!-- X (Twitter) -->
                    <a href="https://x.com/jwc_sa" target="_blank" class="w-12 h-12 rounded-full bg-secondary/20 flex items-center justify-center text-secondary hover:bg-secondary hover:text-dark hover:scale-110 transition-all duration-300" title="X (Twitter)">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                    </a>
                    <!-- LinkedIn -->
                    <a href="https://www.linkedin.com" target="_blank" class="w-12 h-12 rounded-full bg-secondary/20 flex items-center justify-center text-secondary hover:bg-secondary hover:text-dark hover:scale-110 transition-all duration-300" title="LinkedIn">
                    ...
                    <!-- Facebook -->
                    <a href="https://www.facebook.com" target="_blank" class="w-12 h-12 rounded-full bg-secondary/20 flex items-center justify-center text-secondary hover:bg-secondary hover:text-dark hover:scale-110 transition-all duration-300" title="Facebook">
